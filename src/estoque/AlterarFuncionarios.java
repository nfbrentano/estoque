...
public class AlterarFuncionarios extends javax.swing.JFrame {
    ...
    public AlterarFuncionarios() {
        initComponents();
        this.preencheJComboBoxFuncionario();
     ...
     *
     * @param nome ID usado para selecionar o funcionario a ser preenchido os
     * dados
     */
    public void preencheCadastro(String nome) {
        ResultSet result;
        String sql = "SELECT * FROM funcionarios WHERE nome ='" + nome + "' AND disponibilidade = true ";
        ...
        try {
            ...
            while (result.next()) {
                jTid.setText(result.getString("idfuncionarios"));
                jTnome.setText(result.getString("nome"));
                jTsobrenome.setText(result.getString("sobrenome"));
                jTcpf.setText(result.getString("cpf"));
     ...
     * banco de dados
     */
    public void preencheJComboBoxFuncionario() {
        ResultSet result;
        String sql = "SELECT * FROM funcionarios WHERE disponibilidade = true ORDER BY nome";
        ...
        try {
            ...
            result = stm.executeQuery(sql);
            while (result.next()) {
                jCBfuncionario.addItem(result.getString("nome"));
            }
            con.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    /**
     * Preenche o campo de endereço de ruas na tela do sistema com as
     * informações cadastradas no banco de dados
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTid, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110, 190, -1));
        ...
        getContentPane().add(jTnome, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 140, 190, -1));
        ...
        getContentPane().add(jTsobrenome, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 170, 190, -1));
        getContentPane().add(jTcpf, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 200, 190, -1));
        ...
        getContentPane().add(jCBfuncionario, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 80, 190, -1));

        jLabel14.setText("Funcionario* :");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 80, -1, -1));
    ...
    private void jBalterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBalterarActionPerformed
        ...
        if (controle == false) {
            ...
            funcionariosDAO.updateCadastroFuncionarios(nome, sobrenome, cpf, pais, estado, cidade, bairro, rua, numero, id);
            dispose();
        } else {
    ...
    private void jBdeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBdeletarActionPerformed
        ...
        if (controle == false) {
            ...
            funcionariosDAO.deleteCadastroFuncionarios(jTid.getText());
            dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Campos obrigatorios:" + obrigatorio);
        }
    ...
    private void jCBfuncionarioItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCBfuncionarioItemStateChanged
        ...
        if (controle == false) {
            //insere informações na tela com dados do banco fazendo uso da função preenceCadastro utilizando a variavel funcionario que é
            //as informações do combobox na tela com os nomes de funcionarios
